    ...
    const testimonials = [
        {
            name: 'M　Rさん',
            company: 'フロントエンドを担当',
            comment: '　私は遠方から通学をしていますが、電車に乗っている時間を有効活用し、勉強をして様々な国家資格を取得することができました。この学科のいいところは情報技術という最先端の技術を高校生の時から勉強できるということです。選択科目によってはは大学レベルと同等かそれ以上の技術を勉強することができます。',
        },
        {
            name: 'T　Yさん',
            company: 'バックエンドを担当',
